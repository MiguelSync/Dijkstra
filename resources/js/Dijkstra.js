function iniciaGrafo() {
    ...
    rioSul.addAresta('E1', lontras, 5);
    rioSul.addAresta('E2', presNereu, 7);

    lontras.addAresta('E3', presNereu, 2);
    lontras.addAresta('E4', agronomica, 9);

    presNereu.addAresta('E4', laurentino, 4);

    laurentino.addAresta('E5', agronomica, 2);

    agronomica.addAresta('E6', agrolandia, 6);
...
function calculaDistanciaMinima() {
    ...
    let idVerticeInicio = 1;
    let idVerticeFinal = 6;
